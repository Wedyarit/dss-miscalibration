            ...
            >
                ...
                {confidence}% - <ClientOnly fallback="Medium">{t(currentLevel.label)}</ClientOnly>
                        ...
                        <input
                            ...
                            style={{
                                background:
                                    'linear-gradient(to right, #ef4444 0%, #f97316 20%, #eab308 40%, #3b82f6 60%, #22c55e 80%, #22c55e 100%)'
                            }}
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-5 gap-2">
                        {confidenceLevels.map((level) => (
                            ...
                            >
                                <ClientOnly
                                    fallback={
                                        level.value === 20 ? 'Very Low' :
                                            level.value === 40 ? 'Low' :
                                                level.value === 60 ? 'Medium' :
                                                    level.value === 80 ? 'High' : 'Very High'
                                    }
                                >
                                    {t(level.label)}
                                </ClientOnly>
