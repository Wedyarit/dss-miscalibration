  ...
  en: {
    ...
    studentTest: {
      ...
      confidence: {
        ...
        high: 'High',
        veryHigh: 'Very High',
        justGuessing: 'Just Guessing',
        notSure: 'Not Sure',
        fairlyConfident: 'Fairly Sure',
        verySure: 'Very Sure',
        absolutelyCertain: 'Certain',
        skippedForThisQuestion: 'Confidence check skipped for this question to reduce fatigue.',
      ...
      actions: {
        ...
        logoutConfirmDescription:
          'You have an active test session. Finish current session and switch to another student?',
      },
      risk: {
        secondOpinion: 'Second Opinion',
        analyticPause: 'Analytical Pause',
        highRisk: 'Wait, you answered this very quickly. Are you sure about this specific detail?',
        lowRisk: 'Take a short pause and re-check the key idea.',
        model: 'Model',
        returnToQuestion: 'Re-check logic',
        continue: 'I am sure about my answer',
        waitCooldown: 'Please wait {seconds}s',
        reasons: {
          FAST_ANSWER_COMPLEX_TOPIC: 'You answered quickly on a complex topic.',
          SURE_ERROR_PRONE_DOMAIN: 'High confidence in a topic where mistakes are common.',
          STREAK_BREAK_RISK: 'Your pattern suggests a possible calibration slip.',
          LOW_RISK_CONTINUE: 'Your confidence pattern looks stable.',
          MODEL_UNAVAILABLE: 'Risk model is temporarily unavailable.',
          SOFT_RANDOM_NUDGE: 'This question often causes confusion. Are you sure about your logic?',
        },
      },
    },
    ...
    instructor: {
      ...
      tableHeaders: {
        ...
        whyProblematic: 'Why It Is Problematic',
        recommendationForTeacher: 'Teacher Recommendation',
      },
      insights: {
        classSelfAwareness: 'Calibration Health',
        classSelfAwarenessHint: 'Estimated from calibration quality (ECE).',
        coachability: 'Coachability',
        coachabilityHint: 'Share of errors corrected after intervention.',
        dangerZones: 'False Confidence Zones',
        dangerZonesHint: 'Topics with many confident-but-wrong answers.',
        hiddenStars: 'Hidden Potential',
        hiddenStarsHint: 'Accurate students with low confidence.',
      },
      advanced: {
        title: 'For Experts',
        show: 'Show Advanced',
  ...
  ru: {
    ...
    studentTest: {
      ...
      confidence: {
        ...
        justGuessing: 'Наугад',
        notSure: 'Не уверен',
        fairlyConfident: 'Скорее уверен',
        verySure: 'Уверен',
        absolutelyCertain: 'Точно',
        skippedForThisQuestion:
          'Для снижения усталости в этом вопросе самооценка уверенности не запрашивалась.',
      ...
      actions: {
        switchStudent: 'Сменить студента',
        logoutConfirmDescription:
          'У вас есть активная сессия теста. Завершить текущую сессию и сменить студента?',
      },
      risk: {
        secondOpinion: 'Второе мнение',
        analyticPause: 'Аналитическая пауза',
        highRisk: 'Похоже, вы ответили очень быстро. Хотите перепроверить одну деталь?',
        lowRisk: 'Сделайте короткую паузу и перепроверьте ключевую идею.',
        model: 'Модель',
        returnToQuestion: 'Перепроверить логику',
        continue: 'Я уверен в своем ответе',
        waitCooldown: 'Подождите {seconds}с',
        reasons: {
          FAST_ANSWER_COMPLEX_TOPIC: 'Быстрый ответ на сложную тему.',
          SURE_ERROR_PRONE_DOMAIN: 'Высокая уверенность в теме, где часто ошибаются.',
          STREAK_BREAK_RISK: 'Паттерн ответов указывает на возможный сбой калибровки.',
          LOW_RISK_CONTINUE: 'Профиль уверенности выглядит стабильным.',
          MODEL_UNAVAILABLE: 'Модель риска временно недоступна.',
    ...
    instructor: {
      ...
      tableHeaders: {
        ...
        whyProblematic: 'Почему это проблемно',
        recommendationForTeacher: 'Рекомендация для учителя',
      },
      insights: {
        classSelfAwareness: 'Здоровье калибровки',
        classSelfAwarenessHint: 'Оценка на основе качества калибровки (ECE).',
        coachability: 'Коэффициент обучаемости',
        coachabilityHint: 'Доля ошибок, исправленных после вмешательства.',
        dangerZones: 'Зоны ложной уверенности',
        dangerZonesHint: 'Темы, где много уверенных, но неверных ответов.',
        hiddenStars: 'Скрытый потенциал',
        hiddenStarsHint: 'Точные студенты с низкой уверенностью.',
      },
      advanced: {
        title: 'Для экспертов',
